...
class SalinityPage extends StatefulWidget {
  final String farm_token;
  final String type;

  SalinityPage({required this.farm_token, required this.type});

  @override
  _SalinityPageState createState() => _SalinityPageState();
}

class _SalinityPageState extends State<SalinityPage> {
